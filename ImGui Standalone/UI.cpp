...
void UI::Render()
{
    ...
    //Add Fonts Here
    {
        Fonts::qs_bold32 = io.Fonts->AddFontFromFileTTF("fonts\\Quicksand-Bold.ttf", 32);
        Fonts::qs_bold24 = io.Fonts->AddFontFromFileTTF("fonts\\Quicksand-Bold.ttf", 24);

        Fonts::qs_regular28 = io.Fonts->AddFontFromFileTTF("fonts\\Quicksand-Regular.ttf", 28);
        Fonts::qs_regular18 = io.Fonts->AddFontFromFileTTF("fonts\\Quicksand-Regular.ttf", 18);
    }
    io.Fonts->Build();
